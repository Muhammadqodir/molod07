    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="prose max-w-none">
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mb-8">
                <p class="text-gray-800 font-semibold mb-2">Приложение: Молод 07</p>
                <p class="text-gray-700">Разработчик: Министерство по делам молодежи Кабардино-Балкарской Республики</p>
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 mb-4">
                    ...
                    пользователей мобильного приложения и веб-платформы "Молод 07", разработанной и управляемой
                    Министерством по делам молодежи Кабардино-Балкарской Республики (далее - "Министерство", "мы").
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 mb-4">При использовании приложения "Молод 07" мы можем собирать следующие типы персональных данных:</p>
            ...
            <section class="mb-8">
                ...
                <p class="text-gray-700 mb-4">Министерство по делам молодежи КБР использует ваши персональные данные для:</p>
                <ul class="list-disc list-inside text-gray-700 mb-4 space-y-2">
            ...
            <section class="mb-8">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <p class="text-gray-700 font-semibold mb-2">Министерство по делам молодежи Кабардино-Балкарской Республики</p>
