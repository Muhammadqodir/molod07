<section class="py-16 bg-white">
    <div class="max-w-screen-xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {{-- Карточка 1: Новости --}}
            <a href="{{ route('news.list') }}" class="relative bg-[#F7F9FB] rounded-2xl p-6 overflow-hidden min-h-[220px] block hover:shadow-lg transition-shadow">
            ...
            <a href="{{ route('events.list') }}" class="relative bg-[#F7F9FB] rounded-2xl p-6 overflow-hidden min-h-[220px] block hover:shadow-lg transition-shadow">
            ...
            {{-- Карточка 3: Гранты --}}
            <a href="{{ route('grants.list') }}" class="relative bg-[#F7F9FB] rounded-2xl p-6 overflow-hidden min-h-[220px] block hover:shadow-lg transition-shadow">
            ...
            {{-- Карточка 4: Подкасты --}}
            <a href="{{ route('podcasts.list') }}" class="relative bg-[#F7F9FB] rounded-2xl p-6 overflow-hidden min-h-[220px] block hover:shadow-lg transition-shadow">
