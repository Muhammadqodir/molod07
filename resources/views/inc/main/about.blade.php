<section class="bg-accentbg py-16">
    <div class="max-w-screen-xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div class="bg-[#4D88EF] rounded-2xl relative overflow-hidden md:col-span-6 cursor-pointer hover:bg-[#3570c9] transition"
            ...
            <a href="{{ route('courses.list') }}"
                class="bg-[#fff] rounded-2xl p-6 relative overflow-hidden md:col-span-3 flex items-end cursor-pointer hover:bg-gray-100 transition block"
                ...
                <div class="z-10 mt-10">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        Изучайте курсы, проходите тесты и слушайте подкасты по интересующим вас направлениям и
                        применяйте новые
                        знания
                        в жизни
                    </p>
            ...
            <a href="{{ route('events.list') }}"
                ...
                <x-lucide-arrow-up-right class="absolute top-4 right-4 w-5 h-5 text-gray-500" />
                <div class="z-10 mt-10">
                    <h3 class="text-xl font-semibold mb-3">Твои возможности</h3>
                    <p class="text-gray-700 leading-relaxed">
                        Принимайте участие в мероприятиях, находите работу мечты, предлагайте свои инициативы и влияйте
                        на будущее
                        вашего региона
                    </p>
                </div>
