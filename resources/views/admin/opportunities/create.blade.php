...
@section('title', 'Создать возможность')
...
@section('content')
    <div class="flex items-center gap-4 mb-6">
        ...
        <h1 class="text-3xl">Создать возможность</h1>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea id="participation_conditions"
                              ...
                              rows="4"
                              required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('participation_conditions') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="implementation_period"
                              ...
                              rows="3"
                              required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('implementation_period') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="required_documents"
                              ...
                              rows="4"
                              required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('required_documents') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div>
                            <input type="text"
                                   ...
                                   placeholder="ФИО"
                                   value="{{ old('responsible_person.name') }}"
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <div>
                            <input type="text"
                                   ...
                                   value="{{ old('responsible_person.position') }}"
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <div>
                            <input type="text"
                                   ...
                                   placeholder="Контакт"
                                   value="{{ old('responsible_person.contact') }}"
                                   required
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
